            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <button type="button" class="btn bg-gradient-info  btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#newSchedule">
                            +&nbsp; New Schedule
                        </button>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 ms-auto">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-outline-info mb-0 btn-icon btn-2" type="button" onclick="searchOutlet(true)">
                    ...
                    <form id="edit-schedule-form" role="form" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-6 ms-auto">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <button type="button" id="edit-option-view-btn" onclick="viewEditPotions(true)" class="btn bg-gradient-info w-100 mt-4 mb-0">
                                            Edit
                                        </button>
                                    </div>
                                    <div class="col-md-6">
