...
<section class="min-vh-90 mb-1">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url('../assets/img/curved-images/banner2.png');border-top-left-radius: 0px;border-top-right-radius: 0px;">
        <span class="mask bg-gradient-dark opacity-6"></span>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                    <p class="text-lead text-white">Register to the GasByGas as a customer by filling the bellow details.</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <form role="form text-left" method="POST" id="consumer-register-form">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn bg-gradient-info text-white w-100 my-4 mb-2">Register</button>
                            </div>
