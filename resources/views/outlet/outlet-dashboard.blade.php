                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button class="btn btn-outline-gradient-info mb-0 btn-icon btn-2" type="button" onclick="searchConsumerByEmail('new')">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="mark-payment-form" role="form" method="POST">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button class="btn btn-outline-info mb-0 btn-icon btn-2" type="button" onclick="searchRequestByToken('payment')">
                                    <i class="fas fa-search"></i> Search
                                </button>
                            </div>
                    ...
                    <div class="text-center">
                        <button type="submit" id="mark-payment-submit-button" class="btn bg-gradient-info w-100 mt-4 mb-0">Mark Empty and Payment</button>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="mark-pickup-form" role="form" method="POST">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button class="btn btn-outline-info mb-0 btn-icon btn-2" type="button" onclick="searchRequestByToken('pickup')">
                                    <i class="fas fa-search"></i> Search
                                </button>
                            </div>
                    ...
                    <div class="text-center">
                        <button type="submit" id="mark-pickup-submit-button" class="btn bg-gradient-info w-100 mt-4 mb-0">Mark Pickup</button>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="re-assign-form" role="form" method="POST">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button class="btn btn-outline-info mb-0 btn-icon btn-2" type="button" onclick="searchRequestByToken('reAssign')">
                                    <i class="fas fa-search"></i> Search
                                </button>
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button class="btn btn-outline-info mb-0 btn-icon btn-2" type="button" onclick="searchConsumerByEmail('reAssign')">
                                    <i class="fas fa-search"></i> Search
                                </button>
                            </div>
                    ...
                    <div class="text-center">
                        <button type="submit" id="re-assign-submit-button" class="btn bg-gradient-info w-100 mt-4 mb-0">Assign New Consumer</button>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
